...
<html lang="en" dir="ltr">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="navbar-text" align="right" style="padding-right:5px">
            <?php echo $user ?>
        </div>
        <form class="form-inline">
            <button class="btn btn-sm btn-outline-secondary" type="button" onclick="location.href='index.php'">Log Out</button>
        </form>
    </nav>
        <h1 style="margin-left:1%">Welcome!</h1>
    </body>
</html>