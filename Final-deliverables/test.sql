...
--
-- Host: localhost:8889
-- Generation Time: Apr 21, 2020 at 02:07 AM
...
(2, 'tyler', 'g', 'resume', 'test@mail.com', '1', 'Outside Applicant', '', '', 1),
(3, 't', 't', 't', 't@g.com', '12', NULL, NULL, NULL, 1),
(4, 'tyler', 'gallegos', 'resume', 'create@test.com', '123', NULL, NULL, NULL, 1);
...
--
-- Dumping data for table `Search Committee`
--

INSERT INTO `Search Committee` (`search_committee_id`, `comp_id`, `sc_address`, `sc_email`, `sc_last_name`, `sc_name`, `sc_password`, `sc_status`, `job_id`) VALUES
(1, 2, '123 Street', 'sc@work.com', 'Smith', 'Mark', 'admin', 'admin', 1);
...
ALTER TABLE `Search Committee`
  ...
  ADD KEY `job_opening_id` (`job_id`) USING BTREE;
...
--
ALTER TABLE `Applicants`
  MODIFY `applicants_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `Search Committee`
  MODIFY `search_committee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `Search Committee`
  ADD CONSTRAINT `job_opening_id2(fk)` FOREIGN KEY (`job_id`) REFERENCES `Job Opening` (`opening_id`);
